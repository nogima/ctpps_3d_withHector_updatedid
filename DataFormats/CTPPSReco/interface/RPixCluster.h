#ifndef DataFormats_CTPPS_RPixCluster_h
#define DataFormats_CTPPS_RPixCluster_h

/*
  \class RPixCluster 
  \brief RPixCluster stores the information of CTPPS Tracker clusters of 3D pixels
...
RPixCluster(unsigned int isize, uint16_t * adcs,         
...
inline bool operator<( const RPixCluster& one, const RPixCluster& two) {
