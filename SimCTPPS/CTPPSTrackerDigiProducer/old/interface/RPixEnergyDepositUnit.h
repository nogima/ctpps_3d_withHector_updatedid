#ifndef SimCTPPS_CTPPSTrackerDigiProducer_ENERGY_DEPOSIT_UNIT_H
#define SimCTPPS_CTPPSTrackerDigiProducer_ENERGY_DEPOSIT_UNIT_H
...
#endif  //SimCTPPS_CTPPSTrackerDigiProducer_ENERGY_DEPOSIT_UNIT_H
