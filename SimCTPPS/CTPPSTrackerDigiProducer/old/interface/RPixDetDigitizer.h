...
#include "SimCTPPS/CTPPSTrackerDigiProducer/interface/RPixDummyROCSimulator.h"
...
#include "SimCTPPS/CTPPSTrackerDigiProducer/interface/RPixPileUpSignals.h"
...
class RPixDetDigitizer
{
  public:
    ...
    void run(const std::vector<PSimHit> &input, const std::vector<int> &input_links, 
	     std::vector<PixelDigi> &output_digi, //std::vector<RPDetTrigger> &output_trig, 
