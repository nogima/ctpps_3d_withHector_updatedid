...
'root://eoscms//eos/cms/store/user/jjhollar/012017_PixelDAQTests/pixel_raw_minidaq_run292779_LS1.root'
 ),
...
process.MessageLogger = cms.Service("MessageLogger",
    ...
    destinations = cms.untracked.vstring('r2dnoD'),
    r2dnoD = cms.untracked.PSet( threshold = cms.untracked.string('ERROR'))
)

process.out = cms.OutputModule("PoolOutputModule",
#    fileName =  cms.untracked.string('file:digis_PixelAlive_1462_2_RAW.root'),
    fileName =  cms.untracked.string('file:digis_run292779_RAW.root'),
